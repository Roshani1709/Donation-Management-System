                        ...
                        <div class="border p-4">
                            <div class="row text-center text-lg-left">
                                ...
                                <div class="col-12 col-lg-9">
                                    <h2
                                        class="fables-second-text-color font-20 semi-font my-2 mb-lg-3 about-block-heading">
                                        We’re Creative</h2>
                        ...
                        <div class="border p-4">
                            <div class="row text-center text-lg-left">
                                ...
                                <div class="col-12 col-lg-9">
                                    ...
                                    <div class="font-15 fables-forth-text-color">
                                        Our platform is highly customizable, allowing users to tailor their experience
                                        and support causes in ways that matter most to them.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row overflow-hidden" style="margin-left:50px;margin-top : 100px;">
                    <div class="col-12 col-md-6">
                        <div class="image-container translate-effect-right"
                            style="width: 500px;margin-left:-100px; height:700px">
                            <img src="assets/custom/images/mission-img.jpg" alt="Fables Template" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-12 col-md-6 mt-4 mt-md-0"> 
                        <span   
                        class="fables-iconrocket-icon fables-second-text-color fa-3x"></span>
                        <h2 class="font-30 font-weight-bold fables-second-text-color my-4 d-inline-block d-lg-block wow fadeInRight"
                            data-wow-duration="1.5s">Our Mission</h2>
                        <div class="fables-vision-detail fables-forth-text-color wow fadeInRight"
                            data-wow-duration="1.5s">
                            Our mission is to empower individuals and organizations by providing a reliable platform for
                            charitable giving. We aim to streamline the donation process, making it easy for anyone to
                            support causes they are passionate about.<br>
                            Through transparency and accountability, we ensure that every contribution is used
                            effectively to create real change. We are committed to fostering a sense of community and
                            collaboration among donors, volunteers, and beneficiaries. By driving social impact, we hope
                            to inspire more people to engage in philanthropy and make a difference in the world.
                        </div>
                    </div>
                </div>
                ...
                <div class="row overflow-hidden">
                    <div class="col-12 col-md-6">
                        ...
                        <h2 class="font-30 font-weight-bold fables-second-text-color my-4 wow fadeInLeft d-inline d-lg-block"
                            data-wow-duration="1.5s">Our Vision</h2>
                        <div class="fables-forth-text-color mt-4 wow fadeInLeft" data-wow-duration="1.5s">
                            Our vision is to build a trusted and accessible platform where people can make a difference
                            through their donations.
                            We aim to connect generous individuals with impactful causes, ensuring that every
                            contribution reaches those who need it most.<br><br>
                            Transparency and accountability are at the heart of our mission, fostering trust within our
                            community of donors. By leveraging cutting-edge technology, we strive to make the donation
                            process seamless and efficient. Together, we believe we can create a lasting positive impact
                            on the world
                        </div>
                    </div>
                    <div class="col-12 col-md-6 mt-4 mt-md-0">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="footer-charity-text">
                        ...
                        <p>Your generosity can transform lives. By supporting our charity, you help provide vital
                            resources like food, shelter, and education to those in need. Every donation, big or small,
                            makes a lasting impact. Join us in creating a brighter future for everyone!</p>
                        <br>
                        <br>
                        <br><br>
