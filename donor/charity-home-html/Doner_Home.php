                ...
                <div class="container" style="height:100px;">
                    <div class="row">
                        ...
                        <div style="margin-left:-150px;">
                            <div class="menu">
                                <ul class="nav navbar-nav" style="margin-top:-110px">
                                    <li class="active" style="margin-right: 15px;"><a href="Doner_Home.php">HOME</a>
                                    </li>
                                    <li style="margin-right: 10px;"><a href="Categories.php">CATEGORIES</a></li>
                                    <li style="margin-right: 10px;"><a href="Donation_History.php">DONATION HISTORY</a>
                                    </li>
                                    <li style="margin-right: 10px;"><a href="Donate_Money.php">DONATE NOW</a></li>
