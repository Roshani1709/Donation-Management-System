...
<body>
    <div class="wrapper">
        ...
        <section>
            <div class="container" style="margin:100px 20px; width: 100%; height: 100%;">
                <?php
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['name']) && isset($_POST['image']) && isset($_POST['details'])) {
                    ...
                    header('Location: Request_Now.php');
                    exit();
                }
                ...
                <div class='card'>
                    ...
                    <div class='card-body'>
                        ...
                        <form method='POST'>
                            ...
                            <button type='submit' class='btn btn-custom'>Requset Now</button>
                        </form>
                    </div>
                </div>
              </div>";
