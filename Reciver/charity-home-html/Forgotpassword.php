...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['Receiver_Name']) && !isset($_POST['Security_Answer'])) {
        $receiverName = $_POST['Receiver_Name'];

        $sql = "SELECT Security_Question, Security_Answers, Password FROM tblreceiver WHERE Receiver_Name = '$receiverName '";
    ...
    <div class="form-container">
        ...
        <?php if (!empty($securityQuestion)): ?>
            <form method="POST" action="">
                <input type="hidden" name="Receiver_Name" value="<?php echo htmlspecialchars($donorName); ?>">
