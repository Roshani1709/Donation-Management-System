...
<body>
    <div class="wrapper">
        ...
        <section
            style="font-size:20px; padding: 50px; display: flex; flex-direction: column;">
            <?php
            ...
            if (mysqli_num_rows($res) > 0) {
                echo "<table cellpadding='10' cellspacing='0' align='center' style='margin: 0 auto;margin-left:-180px;'>";
                $counter = 0;
            ...
            <td style='padding: 15px;'>
                <div class='card' style='width: 25rem; text-align: center; padding: 15px; border-radius: 10px; margin-bottom: 20px; background-color: rgba(255, 255, 255, 0.9);'>
                    <img src='" . $r['Image'] . "' alt='Image of " . $r['Admin_Name'] ."' class='card-img-top' style='width: 100%; height: auto; border-radius: 50%; object-fit: cover; max-width: 200px; margin-bottom: 15px;'>
                    
                    <div class='card-body'>
                        <h5 class='card-title'><strong>Admin ID:</strong> " . htmlspecialchars($r['Admin_id']) . "</h5>
                        <p class='card-text'><strong>Admin Name:</strong> " . htmlspecialchars($r['Admin_Name']) . "</p>
                        <p class='card-text'>
                            <strong>Email:</strong> 
                            <a href='mailto:" . htmlspecialchars($r['Email']) . "'>" . htmlspecialchars($r['Email']) . "</a>
                        </p>
                        <p class='card-text'><strong>Phone No:</strong> " . htmlspecialchars($r['Phoneno']) . "</p>
                        
                        <a href='Contact_us.php?aid=" . urlencode($r['Admin_id']) . "&rname=" . urlencode($_SESSION['rname']) . "&aname=" . urlencode($r['Admin_Name']) . "' class='btn btn-primary'>
                            Contact Us
                        </a>
                    </div>
                </div>
