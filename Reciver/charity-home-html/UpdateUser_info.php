...
<body>
    <div class="wrapper">
        ...
        <section>
            ...
            if (isset($rname)) {
                $q = "SELECT * FROM tblreceiver WHERE Receiver_Name ='$rname'";
            ...
            <div class="container" style="margin:30px 430px; width: 100%; height: 400px;">
                <div class="row my-4 my-lg-5">
                    <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center">
                        <p class="font-20 semi-font fables-main-text-color mt-4 mb-4 mb-lg-5" style="font-size:50px">
                            Update Profile </p>
                        <br>
                        <form style="height:90px;">
                            <div class="form-group">
                                <div class="input-icon">
                                    <input type="text"
                                        ...
                                        placeholder="user name" name="dname" value="<?php echo $r['Receiver_Name']; ?>"
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    <input type="email"
                                        class="form-control rounded-0 py-3 pl-5 font-13 sign-register-input"
                                        name="email" style="height:50px; font-size:20px; font-weight:600;"
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    <input type="text"
                                        class="form-control rounded-0 py-3 pl-5 font-13 sign-register-input"
                                        name="bname" style="height:50px; font-size:20px; font-weight:600;"
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    <input type="text"
                                        class="form-control rounded-0 py-3 pl-5 font-13 sign-register-input"
                                        name="bcode" style="height:50px; font-size:20px; font-weight:600;"
                                        value="<?php echo $r['Bank_Ifsc_Code']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-icon">
                                    <input type="text"
                                        class="form-control rounded-0 py-3 pl-5 font-13 sign-register-input" name="qus"
                                        style="height:50px; font-size:20px; font-weight:600;"
                                        value="<?php echo $r['Security_Question']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-icon">
                                    <input type="text"
                                        class="form-control rounded-0 py-3 pl-5 font-13 sign-register-input" name="ans"
                                        style="height:50px; font-size:20px; font-weight:600;"
                                        value="<?php echo $r['Security_Answers']; ?>">
                                </div>
                            </div>
                            <button type="submit"
                                ...
                                style="font-size:20px" name="update">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            if (isset($_REQUEST['update'])) {
                ...
                $rname_new = $_REQUEST['dname']; // Corrected from 'rname' to 'dname'
                ...
                // Corrected SQL query: removed 'null' and fixed table name
                $q = "UPDATE tblreceiver 
          SET Receiver_Name='$rname_new', Email='$email',
              Bank_Name='$bname', Bank_Ifsc_Code='$bcode', Security_Question='$qus', Security_Answers='$ans'
          WHERE Receiver_Name='$rname'";

                if (mysqli_query($mysql, $q)) {
                    $_SESSION['rname'] = $rname_new;
                    echo "<script>
                alert('$rname, your profile was edited successfully');
                setTimeout(function() {
