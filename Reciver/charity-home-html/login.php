        ...
        <div class="container" style="margin:200px 430px; width: 100%; height: 100%;">
            <div class="row my-4 my-lg-5">
                <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center">
                    <p class="font-20 semi-font fables-main-text-color mt-4 mb-4 mb-lg-5" style="font-size:50px">Sign In As Recevier </p>
</br>
                    <form style="height:90px;">
                        <div class="form-group" > 
                            <div class="input-icon">
                                <input type="text" class="form-control rounded-0 py-3 pl-5 font-13 sign-register-input"  placeholder="Enter User Name" name="rname"style="height:50px; font-size:20px; font-weight:600;" value="<?php if (isset($_COOKIE['receiver_name'])) echo $_COOKIE['receiver_name']; ?>"> 
                            </div>
...
if (isset($_REQUEST['login'])) {
    ...
    $pwd = $_REQUEST['pwd'];
    require "db.php";
    $q = "SELECT * FROM tblreceiver WHERE Receiver_Name = '$rname' AND Password = '$pwd'";
    $res = mysqli_query($mysql, $q);
    $r = mysqli_num_rows($res);
    if ($r > 0) {

        if (isset($_REQUEST['remember'])) {
            setcookie('receiver_name', $rname, time() + 15 * 24 * 60 * 60);
