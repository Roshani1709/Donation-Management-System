...
<?php 
    ...
    $total_query = "SELECT COUNT(*) as total FROM tblfeedback";
    ...
    $q = "SELECT tf.Feedback_Id, 
                 ...
                 tr.Receiver_id, 
                 tr.Receiver_Name
          FROM tblfeedback AS tf
          LEFT JOIN tblreceiver AS tr
          ON tr.Receiver_id = tf.Receiver_id
          LEFT JOIN tbldonor AS td
          ON td.Donor_id = tf.Donor_id
    ...
    if ($nor > 0) {
        ...
        echo "<center style='margin-top:-700px; color:white; margin-left:400px'><h1>View Feedback</h1></center>";
        ...
        // Show "First" link
        if ($current_page > 1) {
            echo "<a href='View_Feedback?page=1' style='color:white; font-weight:bold; text-decoration:none; margin: 0 5px;'>First</a> ";
        }
        ...
        for ($page = 1; $page <= $total_pages; $page++) {
            if ($page == $current_page) {
                ...
                echo "<a href='View_Feedback?page=$page' style='color:white; font-weight:bold; text-decoration:none; margin: 0 5px;'>$page</a>";
            }
        }

        // Show "Last" link
        if ($current_page < $total_pages) {
            echo "<a href='View_Feedback?page=$total_pages' style='color:white; font-weight:bold; text-decoration:none; margin: 0 5px;'>Last</a>";
        }
